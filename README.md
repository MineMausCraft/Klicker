...
*OPButton    
      ...
      desc:Wenn du jetzt mit der Evolution beginnst bekommst du [round(pow(Insekten:earned/1000000000000,0.3)-Evo:earned)] Evos !
      on click:anim icon wobble
	  ...
	  on click:if (Insekten>1000000000000) yield round(pow(Insekten:earned/1000000000000,0.3)-Evo:earned) Evo
...
*UgLimitAmeise1
        name:100 Ameisen
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Ameisen!
        icon:icons[5,8] icons[0,0]
        cost:1400000 Insekten
        req:40 Ameisen
...
*UgLimitAmeise3
        name:200 Ameisen
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Ameisen!
        icon:icons[5,8] icons[0,0]
        cost:1400000000000 Insekten
        req:140 Ameisen	
		on earn:yield 50 Ameisenlimit
*UgLimitAmeise4
        name:250 Ameisen
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Ameisen!
        icon:icons[5,8] icons[0,0]
        cost:1400000000000000 Insekten
        req:190 Ameisen	
		on earn:yield 50 Ameisenlimit

*UgLimitTermite1
        name:100 Termite
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Termiten!
...
*UgLimitTermite3
        name:200 Termite
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Termiten!
        icon:icons[5,8] icons[0,1]
        cost:1400000000000 Insekten
        req:140 Termite	
		on earn:yield 50 Termitenlimit
*UgLimitTermite4
        name:250 Termite
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Termiten!
        icon:icons[5,8] icons[0,1]
        cost:1400000000000000 Insekten
        req:190 Termite	
		on earn:yield 50 Termitenlimit
...
*UgLimitFliege1
        name:100 Fliege
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Fliegen!
        icon:icons[5,8] icons[0,2]
        cost:15400000 Insekten
        req:40 Fliege
...
*UgLimitFliege3
        name:200 Fliege
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Fliegen!
        icon:icons[5,8] icons[0,2]
        cost:15400000000000 Insekten
        req:1540 Fliege	
		on earn:yield 50 Fliegenlimit
*UgLimitFliege4
        name:250 Fliege
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Fliegen!
        icon:icons[5,8] icons[0,2]
        cost:15400000000000000 Insekten
        req:190 Fliege	
		on earn:yield 50 Fliegenlimit

*UgLimitKaefer1
        name:100 Kaefer
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Käfern!
        icon:icons[5,8] icons[0,3]
        cost:168000000 Insekten
        req:40 Kaefer
...
*UgLimitKaefer3
        name:200 Kaefer
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Käfern!
        icon:icons[5,8] icons[0,3]
        cost:168000000000000 Insekten
        req:140 Kaefer	
		on earn:yield 50 Kaefernlimit
*UgLimitKaefer4
        name:250 Kaefer
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Käfern!
        icon:icons[5,8] icons[0,3]
        cost:168000000000000000 Insekten
        req:190 Kaefer	
		on earn:yield 50 Kaefernlimit

*UgLimitBiene1
        name:100 Bienen
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Bienen!
        icon:icons[5,8] icons[0,4]
        cost:182000000 Insekten
        req:40 Biene
...
*UgLimitBiene3
        name:200 Bienen
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Bienen!
        icon:icons[5,8] icons[0,4]
        cost:182000000000000 Insekten
        req:140 Biene
		on earn:yield 50 Bienenlimit
*UgLimitBiene4
        name:250 Bienen
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Bienen!
        icon:icons[5,8] icons[0,4]
        cost:182000000000000000 Insekten
        req:190 Biene
		on earn:yield 50 Bienenlimit

*UgLimitRAmeise1
        name:100 RoteAmeisen
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 RoteAmeisen!
        icon:icons[5,8] icons[0,5]
        cost:1960000000 Insekten
        req:40 RoteAmeise
		on earn:yield 50 RoteAmeisenlimit
*UgLimitRAmeise2
        name:150 RoteAmeisen
...
*UgLimitRAmeise3
        ...
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 RoteAmeisen!
        icon:icons[5,8] icons[0,5]
        cost:1960000000000000 Insekten
        req:140 RoteAmeise
		on earn:yield 50 RoteAmeisenlimit
*UgLimitRAmeise4
        name:250 RoteAmeisen
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 RoteAmeisen!
        icon:icons[5,8] icons[0,5]
        cost:1960000000000000000 Insekten
        req:190 RoteAmeise
		on earn:yield 50 RoteAmeisenlimit

*UgLimitGrKaefer1
        name:100 GroßeKäfer
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 GroßeKäfer!
        icon:icons[5,8] icons[0,6]
        cost:28000000000 Insekten
        req:40 GrosserKaefer
...
*UgLimitGrKaefer3
        name:200 GroßeKäfer
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 GroßeKäfer!
        icon:icons[5,8] icons[0,6]
        cost:28000000000000000 Insekten
        req:140 GrosserKaefer
		on earn:yield 50 GrKaeferlimit
*UgLimitGrKaefer4
        name:250 GroßeKäfer
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 GroßeKäfer!
        icon:icons[5,8] icons[0,6]
        cost:28000000000000000000 Insekten
        req:190 GrosserKaefer
		on earn:yield 50 GrKaeferlimit

*UgLimitSchmetter1
        name:100 Schmetterlinge
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Schmetterlinge!
        icon:icons[5,8] icons[0,7]
        cost:420000000000 Insekten
        req:40 Schmetterlinge
		on earn:yield 50 Schmetterlimit
*UgLimitSchmetter2
        name:150 Schmetterlinge
...
*UgLimitSchmetter3
        ...
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Schmetterlinge!
        icon:icons[5,8] icons[0,7]
        cost:420000000000000000 Insekten
        req:140 Schmetterlinge
		on earn:yield 50 Schmetterlimit
*UgLimitSchmetter4
        name:250 Schmetterlinge
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Schmetterlinge!
        icon:icons[5,8] icons[0,7]
...
*UgLimitGras1
        name:100 Gras
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Gräser!
        icon:icons[5,8] icons[2,0]
        cost:1300000 Insekten
        req:40 Gras
...
*UgLimitGras3
        name:200 Gras
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Gräser!
        icon:icons[5,8] icons[2,0]
        cost:1300000000000 Insekten
        req:140 Gras	
		on earn:yield 50 Graslimit
*UgLimitGras4
        name:250 Gras
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Gräser!
        icon:icons[5,8] icons[2,0]
        cost:1300000000000000 Insekten
        req:190 Gras	
		on earn:yield 50 Graslimit	

*UgLimitAst1
        name:100 Ast
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Äste!
        icon:icons[5,8] icons[2,1]
        cost:1870000 Insekten
        req:40 Ast
...
*UgLimitAst3
        name:200 Ast
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Äste!
        icon:icons[5,8] icons[2,1]
        cost:1870000000000 Insekten
        req:140 Ast	
		on earn:yield 50 Astlimit
*UgLimitAst4
        name:250 Ast
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Äste!
        icon:icons[5,8] icons[2,1]
        cost:1870000000000000 Insekten
        req:190 Ast	
		on earn:yield 50 Astlimit

*UgLimitWurzel1
        name:100 Wurzel
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Wurzeln!
        icon:icons[5,8] icons[2,2]
        cost:9530000 Insekten
        req:40 Wurzel
...
*UgLimitWurzel3
        name:200 Wurzel
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Wurzeln!
        icon:icons[5,8] icons[2,2]
        cost:9530000000000 Insekten
        req:140 Wurzel	
		on earn:yield 50 Wurzellimit
*UgLimitWurzel4
        name:250 Wurzel
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Wurzeln!
        icon:icons[5,8] icons[2,2]
        cost:9530000000000000 Insekten
        req:190 Wurzel	
		on earn:yield 50 Wurzellimit

*UgLimitStein1
        name:100 Stein
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Steine!
        icon:icons[5,8] icons[2,3]
        cost:104000000 Insekten
        req:40 Stein
...
*UgLimitStein3
        name:200 Stein
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Steine!
        icon:icons[5,8] icons[2,3]
        cost:104000000000000 Insekten
        req:140 Stein	
		on earn:yield 50 Steinlimit
*UgLimitStein4
        name:250 Stein
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Steine!
        icon:icons[5,8] icons[2,3]
        cost:104000000000000000 Insekten
        req:190 Stein	
		on earn:yield 50 Steinlimit

*UgLimitDreck1
        name:100 Dreck
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Dreck!
...
*UgLimitDreck3
        name:200 Dreck
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Dreck!
        icon:icons[5,8] icons[2,4]
        cost:1126670000000000 Insekten
        req:140 Dreck	
		on earn:yield 50 Drecklimit
*UgLimitDreck4
        name:250 Dreck
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Dreck!
        icon:icons[5,8] icons[2,4]
        cost:1126670000000000000 Insekten
        req:190 Dreck	
		on earn:yield 50 Drecklimit

*UgLimitABuch1
        name:100 AltesBuch
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 AlteBücher!
        icon:icons[5,8] icons[2,5]
        cost:12133330000 Insekten
        req:40 AltesBuch
...
*UgLimitABuch3
        name:200 AltesBuch
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 AlteBücher!
        icon:icons[5,8] icons[2,5]
        cost:12133330000000000 Insekten
        req:140 AltesBuch	
		on earn:yield 50 ABuchlimit
*UgLimitABuch4
        name:250 AltesBuch
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 AlteBücher!
        icon:icons[5,8] icons[2,5]
        cost:12133330000000000000 Insekten
        req:190 AltesBuch	
		on earn:yield 50 ABuchlimit

*UgLimitKarnickel1
        name:100 Karnickel
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Karnickel!
        icon:icons[5,8] icons[2,6]
        cost:17333333000 Insekten
        req:40 Karnickel
...
*UgLimitKarnickel3
        name:200 Karnickel
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Karnickel!
        icon:icons[5,8] icons[2,6]
        cost:17333333000000000 Insekten
        req:140 Karnickel	
		on earn:yield 50 Karnickellimit
*UgLimitKarnickel4
        name:250 Karnickel
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Karnickel!
        icon:icons[5,8] icons[2,6]
        cost:17333333000000000000 Insekten
        req:190 Karnickel	
		on earn:yield 50 Karnickellimit

*UgLimitSonnenblume1
        name:100 Sonnenblume
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Sonnenblumen!
        icon:icons[5,8] icons[2,7]
        cost:286000000000 Insekten
        req:40 Sonnenblume
		on earn:yield 50 Sonnenblumenlimit
*UgLimitSonnenblume2
        name:150 Sonnenblume
...
*UgLimitSonnenblume3
        ...
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Sonnenblumen!
        icon:icons[5,8] icons[2,7]
        cost:286000000000000000 Insekten
        req:140 Sonnenblume	
		on earn:yield 50 Sonnenblumenlimit
*UgLimitSonnenblume4
        name:250 Sonnenblume
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Sonnenblumen!
        icon:icons[5,8] icons[2,7]
        cost:286000000000000000000 Insekten
        req:190 Sonnenblume	
		on earn:yield 50 Sonnenblumenlimit

*UgLimitFred1
        name:100 Fred
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Freds!
        icon:icons[5,8] icons[2,8]
        cost:4420000000000 Insekten
        req:40 Fred
...
*UgLimitFred3
        name:200 Fred
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Freds!
        icon:icons[5,8] icons[2,8]
        cost:4420000000000000000 Insekten
        req:140 Fred	
		on earn:yield 50 Fredslimit
*UgLimitFred4
        name:250 Fred
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Freds!
        icon:icons[5,8] icons[2,8]
        cost:4420000000000000000000 Insekten
        req:190 Fred	
		on earn:yield 50 Fredslimit

*UgLimitBbusch1
        name:100 Blumenbüsche
        desc:<.> Vergrößere deine Kolonie auf bis zu 100 Blumenbüsche!
        icon:icons[5,8] icons[2,9]
        cost:65000000000000 Insekten
        req:40 Blumenbusch
		on earn:yield 50 Bbuschlimit
*UgLimitBbusch2
        name:150 Blumenbüsche
...
*UgLimitBbusch3
        ...
        desc:<.> Vergrößere deine Kolonie auf bis zu 200 Blumenbüsche!
        icon:icons[5,8] icons[2,9]
        cost:65000000000000000000 Insekten
        req:140 Blumenbusch	
		on earn:yield 50 Bbuschlimit
*UgLimitBbusch4
        name:250 Blumenbüsche
        desc:<.> Vergrößere deine Kolonie auf bis zu 250 Blumenbüsche!
        icon:icons[5,8] icons[2,9]
...
*TEMPLATE
		...
		on click:anim glow
		class:noBackground
		passive:multiply yield of SammlerAmeisen by 1.75
		desc:<.> Erhöht die Produktion der SammlerAmeisen um <b>75</b> %.
//180
*UgBISammlerA1
		name:Längere Finger
...
*UgBISammlerA2
		...
		req:UgBISammlerA1
*UgBISammlerA3
		name:Empfindliche Finger
		icon:iconse[1,2]
		cost:1800000 Insekten
		req:UgBISammlerA2
*UgBISammlerA4
		name:Starke Füße
		icon:iconse[1,3]
		cost:18000000 Insekten
		req:UgBISammlerA3
*UgBISammlerA5
		name:Große Füße
		icon:iconse[1,4]
		cost:180000000 Insekten
		req:UgBISammlerA4
*UgBISammlerA6
		name:Lange Füße
		icon:iconse[1,5]
		cost:1800000000 Insekten
		req:UgBISammlerA5
*UgBISammlerA7
		name:Starke Beine
		icon:iconse[1,6]
		cost:18000000000 Insekten
		req:UgBISammlerA6
*UgBISammlerA8
		name:Lange Beine
		icon:iconse[1,7]
		cost:180000000000 Insekten
		req:UgBISammlerA7
*UgBISammlerA9
		name:Extra Arme
		icon:iconse[1,8]
		cost:1800000000000 Insekten
		req:UgBISammlerA8
*UgBISammlerA10
		name:Extra Beine
		icon:iconse[1,9]
		cost:18000000000000 Insekten
		req:UgBISammlerA9
*UgBISammlerA11
		name:Tragen + 1
		icon:iconse[1,10]
		cost:1800000000000000 Insekten
		req:UgBISammlerA10
*UgBISammlerA12
		name:Vorschub
		icon:iconse[1,11]
		cost:180000000000000000 Insekten
		req:UgBISammlerA11
*UgBISammlerA13
		name:Vorwärts + 1
		icon:iconse[1,12]
		cost:18000000000000000000 Insekten
		req:UgBISammlerA12
*UgBISammlerA14
		name:Starke Arme
		icon:iconse[1,13]
		cost:1800000000000000000000 Insekten
		req:UgBISammlerA13
*UgBISammlerA15
		name:Starker Rücken
		icon:iconse[1,14]
		cost:180000000000000000000000 Insekten
		req:UgBISammlerA14
...
*UgBIMoskito1
		name:Moskitole
		icon:icons[17,0]
		cost:12700000000000 Insekten,6200000000000 Larven, 3150000000000 BauMaterial
		req:12700000000000 Insekten:earned and 1 Moskito
*UgBIMoskito2
		name:Nachtflügler
		icon:icons[17,1]
		cost:1270000000000000 Insekten,620000000000000 Larven, 315000000000000 BauMaterial
		req:1270000000000000 Insekten:earned and UgBIMoskito1
*UgBIMoskito3
		name:Vampier
		icon:icons[17,2]
		cost:127000000000000000 Insekten,62000000000000000 Larven, 31500000000000000 BauMaterial
		req:127000000000000000 Insekten:earned and UgBIMoskito2
*UgBIMoskito4
		name:Blutsauger
		icon:icons[17,3]
		cost:12700000000000000000 Insekten,6200000000000000000 Larven, 3150000000000000000 BauMaterial
		req:12700000000000000000 Insekten:earned and UgBIMoskito3
*UgBIMoskito5
		name:Weite Flügel
		icon:icons[17,4]
		cost:1270000000000000000000 Insekten,620000000000000000000 Larven, 315000000000000000000 BauMaterial
		req:1270000000000000000000 Insekten:earned and UgBIMoskito4
*UgBIMoskito6
		name:Schöne Flügel
		icon:icons[17,5]
		cost:127000000000000000000000 Insekten,62000000000000000000000 Larven, 31500000000000000000000 BauMaterial
		req:127000000000000000000000 Insekten:earned and UgBIMoskito5
*UgBIMoskito7
		name:Lange Flügel
		icon:icons[17,6]
		cost:12700000000000000000000000 Insekten,6200000000000000000000000 Larven, 3150000000000000000000000 BauMaterial
		req:12700000000000000000000000 Insekten:earned and UgBIMoskito6
*UgBIMoskito8
		name:Kurzer Stachel
		icon:icons[17,7]
		cost:1270000000000000000000000000 Insekten,620000000000000000000000000 Larven, 315000000000000000000000000 BauMaterial
		req:1270000000000000000000000000 Insekten:earned and UgBIMoskito7
*UgBIMoskito9
		name:Langer Stachel
		icon:icons[17,8]
		cost:127000000000000000000000000000 Insekten,62000000000000000000000000000 Larven, 31500000000000000000000000000 BauMaterial
		req:127000000000000000000000000000 Insekten:earned and UgBIMoskito8
*UgBIMoskito10
		name:Dicker Stachel
		icon:icons[17,9]
		cost:12700000000000000000000000000000 Insekten,36200000000000000000000000000000 Larven, 3150000000000000000000000000000 BauMaterial
		req:12700000000000000000000000000000 Insekten:earned and UgBIMoskito9
*UgBIMoskito11
		name:Dünner Stachel
		icon:icons[17,10]
		cost:1270000000000000000000000000000000 Insekten,620000000000000000000000000000000 Larven, 315000000000000000000000000000000 BauMaterial
		req:1270000000000000000000000000000000 Insekten:earned and UgBIMoskito10
*UgBIMoskito12
		name:Großer Mücken Stachel
		icon:icons[17,11]
		cost:127000000000000000000000000000000000 Insekten,362000000000000000000000000000000000 Larven, 31500000000000000000000000000000000 BauMaterial
...
*UgbBKarnickel10a
		...
		icon:iconsc[0,9]
		cost:17333333000000000000000000 BauMaterial,175 AltesBuch
		req:17333333000000000000000000 BauMaterial:earned and UgbBKarnickel10
*UgbBKarnickel11a
		name:Riesenkarnickel
		icon:iconsc[0,10]
